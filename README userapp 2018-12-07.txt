...
4. Rebuild app using c:\phil\dev\projects\examples\java\userapp>mvn clean package -Penunciate
5. Go to http://localhost:1234/pmk/restapi/ui and http://localhost:1234/pmk
